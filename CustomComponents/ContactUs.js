...
const ContactUs = () => {
  return (
    <ScrollView style={styles.MainContainer}>
      ...
      <Text style={styles.textStyle}>Outside of U.S</Text>
      <DateComponent number={'+1-631-234-8815 ext. 3501'}></DateComponent>

      <Text style={styles.headingLabel}>Home Loan Questions</Text>

      <Text style={styles.textMedium}>Existing loan inquiries</Text>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
        style={styles.button}>
        <Text style={styles.textBlue}>TiaaBank.myloancare.com</Text>
      </TouchableOpacity>
      ...
      <Text style={[styles.textSmall, styles.topPadding, styles.bottomPadding]}>
        ...
        <Text style={styles.textSmallBold}>
          (for retirement questions only){' '}
        </Text>
        <Text style={styles.textSmall}>
          . This options is available in the U.S. and Canada. Cellular data
          rates may apply.
        </Text>
      </Text>
